...
from lasagne_rnn_layer import stack_rnn
...
class LSTMModel(object):
    ...
    def __init__(self, We_initial, params):
        ...
        l_lstm = stack_rnn(l_emb, l_mask, params.numlayers, params.layersize / 2)
