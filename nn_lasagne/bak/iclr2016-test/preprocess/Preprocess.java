...
public class Preprocess {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<String> data = getSICKdata(prefix+"input.test.txt", pipeline);
        writeFile(outdir+"sicktest",data);
        data = getSICKdata(prefix+"input.all.txt", pipeline);
        writeFile(outdir+"sicktrain",data);
        data = getSICKdata(prefix+"input.test.txt", pipeline);
    ...
    private static ArrayList<String> getSICKdata(String fname,
        ...
        try {
            ...
            for(int i=1; i < lines.size(); i++) {
                ...
                String t1 = getTokenString(arr[0], pipeline);
                String t2 = getTokenString(arr[1], pipeline);
                String score = arr[2];
