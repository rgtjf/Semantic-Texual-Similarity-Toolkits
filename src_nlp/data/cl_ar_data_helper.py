...
def init_arabic_data(config_file, task):
    ...
    LEMMA_DIR = '../../data/lemma/sts-en-ar/bak'
    lemma_dataset = [
        'STS.input.MSRpar.txt',
        'STS.input.MSRvid.txt',
        'STS.input.SMTeuroparl.txt',
        'STS.input.track2.en-ar.txt'
    ]

    TRANSLATOR_DIR = '../../data/translate/sts-en-ar/googleapi'
    translate_dataset = [
        'STS.googleapi.MSRpar.txt',
        'STS.googleapi.MSRvid.txt',
        'STS.googleapi.SMTeuroparl.txt',
        'STS.googleapi.track2.ar-en.txt'
    ]
...
if __name__ == '__main__':
    ...
    DATA_CLEAN_DIR = '../../data_B/sts-ar-en'
