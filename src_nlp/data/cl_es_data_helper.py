...
def init_arabic_data(config_file, task):
    ...
    LEMMA_DIR = '../../data/lemma/sts-en-es/bak'
    lemma_dataset = [
        'STS.input.multisource.txt',
        'STS.input.news.txt',
        'STS.input.track4a.en-es.txt'
    ]

    TRANSLATOR_DIR = '../../data/translate/sts-en-es/googleapi'
    translate_dataset = [
        'STS.googleapi.multisource.txt',
        'STS.googleapi.news.txt',
        'STS.googleapi.track4a.es-en.txt'
    ]
...
if __name__ == '__main__':
    ...
    DATA_CLEAN_DIR = '../../data_B/sts-es-en'
