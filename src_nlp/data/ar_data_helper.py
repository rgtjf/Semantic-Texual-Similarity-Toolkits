...
def init_arabic_data(config_file, task):
    ...
    LEMMA_DIR = '../../data/lemma/sts-ar-ar/bak'
    lemma_dataset = [
        'STS.input.MSRpar.txt',  # 517
        'STS.input.MSRvid.txt',  # 368
        'STS.input.SMTeuroparl.txt', # 203
        'STS.input.track1.ar-ar.txt'
    ]

    TRANSLATOR_DIR = '../../data/translate/sts-ar-ar/manual'
    translate_dataset = [
        'STS.manual.MSRpar.txt',
        'STS.manual.MSRvid.txt',
        'STS.manual.SMTeuroparl.txt',
        'STS.googleapi.track1.ar-ar.txt'
    ]
...
if __name__ == '__main__':
    ...
    DATA_CLEAN_DIR = '../../data_clean/sts-ar-ar'
